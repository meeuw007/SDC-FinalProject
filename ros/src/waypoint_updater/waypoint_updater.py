...
LOOKAHEAD_WPS = 5 # Number of waypoints we will publish. You can change this number default:200
...
class WaypointUpdater(object):
    ...
    def pub_waypoints(self):
        ...
        while not rospy.is_shutdown():
            ...
            if((len(self.base_waypoints.waypoints) > 0) & self.base_waypoints_cb & self.current_pose_cb):
                ...
                #rospy.loginfo("current waypoint index .... %d", current_index)
                #rospy.loginfo("current waypoint x .... %f", self.base_waypoints.waypoints[current_index].pose.pose.position.x)
                #rospy.loginfo("current waypoint y .... %f", self.base_waypoints.waypoints[current_index].pose.pose.position.y)
    ...
    def nearest_front(self):
        ...
        self.wp_front_prev = wp_front%self.wp_num     
